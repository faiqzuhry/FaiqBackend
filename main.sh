...
TIMES="10"
CHATID="1924716333"
KEY="6588287079:AAHHacJ34DkZrM4BfI6D-TsysNKLLCqid10"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m                               FAIQ ZUHRY             \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/faiqzuhry/izinsc/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/faiqzuhry/izinsc/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/faiqzuhry/izinsc/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/faiqzuhry/FaiqBackend/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/faiqzuhry/izinsc/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/faiqzuhry/izinsc/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/SaeRah1920"},{"text":"Contack","url":"https://wa.me/6285161040139"}]]}'
...
wget raw.githubusercontent.com/faiqzuhry/FaiqBackend/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd /bin
git clone  https://github.com/faiqzuhry/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
